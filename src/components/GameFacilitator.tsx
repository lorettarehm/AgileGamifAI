      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col items-center">
            <div
              className={`text-3xl sm:text-4xl lg:text-5xl font-mono font-bold mb-4 ${getTimerColor()}`}
            >
              ...
              >
                {isRunning ? (
                  ...
                  <>
                    ...
                    {timeRemaining === game.duration * 60 ? 'Start' : 'Resume'}
                  </>
                )}
              </Button>
            </div>
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-base sm:text-lg font-semibold mb-4 text-teal-800">
          ...
          <div className="bg-gradient-to-br from-teal-50 to-purple-50 p-4 sm:p-6 rounded-lg mb-4 min-h-[100px] sm:min-h-[120px] flex items-center justify-center border border-teal-200">
            <p className="text-sm sm:text-base lg:text-lg text-center text-teal-800 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            >
              {currentStep === instructionSteps.length - 1 ? 'Complete' : 'Next'}{' '}
              <ChevronRight className="h-4 sm:h-5 w-4 sm:w-5 ml-1" />
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-3 sm:p-4 rounded-lg border border-teal-200">
            <h3 className="font-semibold mb-2 text-sm sm:text-base text-teal-800">
              Materials Needed
            </h3>
            <ul className="list-disc pl-5 space-y-1">
              {game.materials.map((material, index) => (
                <li key={index} className="text-xs sm:text-sm text-teal-700 leading-relaxed">
                  {material}
                </li>
              ))}
            </ul>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-3 sm:p-4 rounded-lg border border-purple-200">
            <h3 className="font-semibold mb-2 text-sm sm:text-base text-purple-800">
              Facilitation Tips
            </h3>
